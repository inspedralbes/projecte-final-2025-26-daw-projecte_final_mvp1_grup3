...
('Fons Platja', 'Un fons tropical per a la teva aplicació', 150, 'skin', '/img/items/fons_platja.png', '{"slot":"fons","skin_key":"fons_platja","i18n_key":"fons_platja"}'),
('Fons Casa', 'Un fons acollidor per a la teva aplicació', 150, 'skin', '/img/items/fons_casa.png', '{"slot":"fons","skin_key":"fons_casa","i18n_key":"fons_casa"}');
