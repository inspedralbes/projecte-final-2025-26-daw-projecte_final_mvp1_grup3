...
export default {
  ...
  methods: {
    ...
    onPlantillaImportada: async function () {
      var self = this;
      self.tancarImportPlantilla();
      if (self.$loopyModal && typeof self.$loopyModal.success === "function") {
        await self.$loopyModal.success("Importat", self.$t("social.import_success"));
      }
    },
  },
};
