# Spec: Habit Details Modal

## Purpose

Provide a secondary details action on home habit cards that opens an in-place modal with expanded habit information — including difficulty, XP, repetition schedule, objective fields, linked external metadata preview, and (for household habits) a weather-context block.
